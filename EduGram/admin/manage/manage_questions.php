...
<body>
    <section>
        <h1>Manage Questions <br><button type="button" class="button" onclick="document.location='add_que.php'">Add new Question</button><button  class ="button" onclick="history.back()">Go Back</button></h1>
        <table>
            <tr>
                <th>ID</th>
                <th>Questions</th>
