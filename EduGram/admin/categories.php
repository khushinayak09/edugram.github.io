        ...
        if($answer == NULL){
            ...
            if($_POST["nul"]==0){
                if(strpos($_POST["preby"],$_SESSION["user"]) === false)
                    $que = "update quans set answer=CONCAT(answer,'<br><b>OR</b><br>".$_POST["answer"]."'), answeredby=CONCAT(answeredby,', @ ".$_SESSION["user"]."') where question like '%".$_POST["question"]."%'";
                else
                    $que = "update quans set answer=CONCAT(answer,'<br><b>OR</b><br>".$_POST["answer"]."'), answeredby = '".$_SESSION["user"]."' where question like '%".$_POST["question"]."%'";
            }
            else
...
<html>
    ...
    <body id="_3">
        ...
        <ul id="nav-bar">
            ...
            <a href="admin_index.html"><li>Home</li></a>
        ...
        <div id="content">
            <h4>
                <a id="title-head" href="categories.php"><b>Categories</b></a>
            </h4>
            <div id="box0">
                <center>
                    <a id="ada" href="#box1">
